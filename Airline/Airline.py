...
st.page_link('https://airline-project1.streamlit.app/', label="Dashboard", icon='🛫', disabled=True, use_container_width=True)
st.page_link('https://airline-project2.streamlit.app/', label="Model", icon='🛫', disabled=True, use_container_width=True)
